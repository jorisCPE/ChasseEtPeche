...
from affichage_carte_14 import *
...
def generer_carte():
    ...
    liste_tuile_11_2 = [[[0, 0, 1, 2, 2, 1, 0],
                    [0, 2, 2, 1, 2, 2, 0],
                    [0, 6, 5, 2, 1, 2, 1],
                    [6, 6, 1, 2, 2, 2, 2],
                    [0, 6, 5, 5, 2, 1, 1],
                    [0, 1, 1, 2, 2, 1, 0],
                    [0, 0, 2, 1, 2, 1, 0],],"tuile_11_2"]
...
def generer_carte_14():
    
    liste_tuile_0_2 = [[[0, 0, 4, 2, 4, 4, 0],
                    [0, 6, 4, 1, 6, 6, 0],
                    [0, 6, 6, 6, 1, 4, 6],
                    [2, 2, 4, 5, 4, 6, 4],
                    [0, 2, 1, 1, 5, 6, 6],
                    [0, 1, 2, 5, 6, 5, 0],
                    [0, 0, 2, 1, 2, 2, 0],],"tuile_0_2"]
    ...
    liste_tuile_2_2 = [[[0, 0, 1, 2, 2, 1, 0],
                    [0, 2, 2, 1, 2, 1, 0],
                    [0, 2, 2, 4, 4, 1, 2],
                    [1, 2, 4, 7, 1, 2, 1],
                    [0, 2, 2, 4, 4, 2, 2],
                    [0, 1, 2, 2, 1, 1, 0],
                    [0, 0, 2, 1, 3, 3, 0],],"tuile_2_2"]
    ...
    liste_tuile_3_2 = [[[0, 0, 2, 4, 1, 2, 0],
                    ...
                    [0, 1, 2, 4, 1, 1, 1],
                    [0, 4, 4, 1, 2, 2, 0],
                    [0, 0, 2, 1, 2, 6, 0],],"tuile_3_2"]
                    

    tuile_3_2 = rotation_tuile(liste_tuile_3_2[0],liste_tuile_3_2[1])

    liste_tuile_4_2 = [[[0, 0, 2, 3, 3, 4, 0],
                    [0, 2, 7, 1, 3, 3, 0],
                    [0, 1, 2, 1, 3, 4, 6],
                    [2, 1, 1, 1, 3, 6, 3],
                    [0, 1, 1, 2, 5, 3, 6],
                    [0, 2, 2, 1, 5, 6, 0],
                    [0, 0, 1, 2, 5, 6, 0],],"tuile_4_2"]
                    

    tuile_4_2 = rotation_tuile(liste_tuile_4_2[0],liste_tuile_4_2[1])

    liste_tuile_5_2 = [[[0, 0, 1, 2, 1, 3, 0],
                    [0, 2, 1, 1, 3, 3, 0],
                    [0, 2, 1, 3, 3, 4, 3],
                    [1, 1, 3, 3, 3, 3, 3],
                    [0, 1, 3, 3, 6, 6, 1],
                    [0, 3, 4, 3, 6, 1, 0],
                    [0, 0, 3, 1, 6, 1, 0],],"tuile_5_2"]
    ...
    liste_tuile_11_2 = [[[0, 0, 2, 1, 1, 1, 0],
                    [0, 1, 2, 1, 2, 2, 0],
                    [0, 2, 2, 2, 2, 2, 1],
                    [1, 2, 1, 2, 5, 1, 2],
                    [0, 2, 1, 2, 1, 5, 1],
                    [0, 2, 2, 5, 6, 6, 0],
                    [0, 0, 1, 2, 6, 6, 0],],"tuile_11_2"]
                    

    tuile_11_2 = rotation_tuile(liste_tuile_11_2[0],liste_tuile_11_2[1])
    
    liste_tuile_12_2 = [[[0, 0, 3, 1, 3, 3, 0],
                    [0, 2, 4, 1, 3, 3, 0],
                    [0, 6, 5, 1, 1, 3, 2],
                    [2, 1, 2, 2, 1, 4, 2],
                    [0, 4, 5, 1, 5, 5, 1],
                    [0, 6, 6, 5, 5, 1, 0],
                    [0, 0, 6, 6, 2, 2, 0],],"tuile_12_2"]
                    

    tuile_12_2 = rotation_tuile(liste_tuile_12_2[0],liste_tuile_12_2[1])

    liste_tuile_13_2 = [[[0, 0, 4, 1, 6, 2, 0],
                    [0, 1, 1, 4, 5, 4, 0],
                    [0, 2, 4, 2, 7, 5, 1],
                    [1, 1, 2, 4, 4, 2, 1],
                    [0, 1, 1, 1, 2, 1, 1],
                    [0, 3, 2, 1, 2, 2, 0],
                    [0, 0, 1, 4, 1, 2, 0],],"tuile_13_2"]
                    

    tuile_13_2 = rotation_tuile(liste_tuile_13_2[0],liste_tuile_13_2[1])
    ...
    liste_tuile_2 = [tuile_0_2, tuile_1_2, tuile_2_2, tuile_3_2, tuile_4_2, tuile_5_2, tuile_6_2, tuile_7_2, tuile_8_2, tuile_9_2, tuile_10_2, tuile_11_2, tuile_12_2, tuile_13_2]

    liste_tuile_melangee, liste_nom_tuile_melangee = melange_tuile_14(liste_tuile_2, vide)

    liste_ressources_tuile = affichage_carte_14(liste_tuile_melangee , 'carte')
